...
public:
    ...
    // 标定板参数
    double cheackerboard_square_size = 0.200;// 单位是m
    Size cheackerboard_grid_size = Size(7,4); // 标定板的内部方格数，注意水平方向为7
    vector<double> cheackerboard_padding = {0.,0.,0.,0.}; // 标定板相对靶纸边缘的padding,方向？
