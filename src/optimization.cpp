                                    ...
                                    VectorXd& Rt_c1_c2)
{
    double w = 1.0;
    ceres::LossFunction *loss_function = NULL;
    ceres::CostFunction *cost_function = new ceres::AutoDiffCostFunction<ClosedupError,2,6,6>(new ClosedupError(Rt_c1_c2, w));
    problem.AddResidualBlock(cost_function, loss_function, params1.data(),params2.data());
}
